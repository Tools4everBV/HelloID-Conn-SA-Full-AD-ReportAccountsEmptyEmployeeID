<!-- Description -->
## Description
This HelloID Service Automation Delegated Form provides an Active Directory report containing the user accounts that have an empty "EmployeeID" attribute. The following options are available:
...
### Powershell data source 'AD-user-generate-table-report-empty-employeeID'
...
### Delegated form task 'AD - Report - Accounts where EmployeeID is empty'
...
## Getting help
_If you need help, feel free to ask questions on our [forum](https://forum.helloid.com/forum/helloid-connectors/service-automation/528-helloid-sa-active-directory-report-ad-accounts-with-empty-employeeid-attribute)_
